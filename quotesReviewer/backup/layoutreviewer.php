...
echo'<form name="reviewer" id="reviewer" action="layoutreviewer2.php">';
...
{
	echo '<tr><td><a href="layoutreviewer2.php/?quoteid='.$var['quote_id'].'">'. $var['quote_id'].'</a></td><td>'.$var['status'].'</td></tr>';
}
echo'</table>';
?>
      </section>
