<!this is the GUI of the quotes approver main page>
<!DOCTYPE html>
...
echo'<form name="approver" id="approver" action="approver2.php?src=1">';
...
foreach($quotes as $var)
{
        ...
        $status=$var['status'];
        echo "<tr><td><a href=\"approver2.php/?quoteid=$quoteid&src=2> $quoteid</a></td><td>:is $status </td></tr>";
        echo'<br>';
}
